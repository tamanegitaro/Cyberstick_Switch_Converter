...
#define CSMODE_MAX 5
#define CSMODE_DEFAULT 0
#define CSMODE_GLOC 1
#define CSMODE_PANZER_DRAGOON 2
#define CSMODE_SPACE_HARRIER 3
#define CSMODE_TEMPEST_4000 4
#define CSMODE_VIRTUA_RACING 5
...
private:
	...
	void process_8bitdo24g_report(uint8_t dev_addr, uint8_t const* report, uint16_t len);
	void process_kbd_hotkey(void);
	uint8_t CSmode;
    ...
    uint8_t _8bitdo24g_dev_addr;
    uint8_t _8bitdo24g_instance;
	bool _8bitdo24g_host_enabled;
