...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v6.21.2"
  WORKING_DIRECTORY "C:/Raspberrypi_Pico/GP2040-CE-0.7.10_Cyberstick_Convert/GP2040-CE/build/_deps/arduinojson-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Raspberrypi_Pico/GP2040-CE-0.7.10_Cyberstick_Convert/GP2040-CE/build/_deps/arduinojson-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Raspberrypi_Pico/GP2040-CE-0.7.10_Cyberstick_Convert/GP2040-CE/build/_deps/arduinojson-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
